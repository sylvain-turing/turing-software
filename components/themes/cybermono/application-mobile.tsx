...
import { ArrowRight, ChevronRight, Smartphone, TabletSmartphone, Cpu, Layers, Shield, Gauge, RefreshCw, Globe } from "lucide-react";
...
const platforms = [
  {
    icon: Smartphone,
    title: "iOS NATIF",
    desc: "Applications Swift performantes, optimisees pour l'ecosysteme Apple et les standards de l'App Store.",
  },
  {
    icon: TabletSmartphone,
    title: "ANDROID NATIF",
    desc: "Applications Kotlin robustes, compatibles avec l'ensemble des appareils Android du marche.",
  },
  {
    icon: Layers,
    title: "CROSS-PLATFORM",
    desc: "React Native et Flutter pour un code unique deploye sur iOS et Android, sans compromis sur la qualite.",
  },
  {
    icon: Globe,
    title: "PWA",
    desc: "Progressive Web Apps installables, fonctionnant hors-ligne avec une experience native dans le navigateur.",
  },
];

const process = [
  { num: "01", title: "CADRAGE", desc: "Definition des fonctionnalites, personas utilisateurs et specifications techniques detaillees." },
  { num: "02", title: "PROTOTYPAGE", desc: "Wireframes interactifs et maquettes haute fidelite validees par vos equipes avant le developpement." },
  { num: "03", title: "SPRINT", desc: "Developpement agile par sprints de 2 semaines avec demos regulieres et ajustements en temps reel." },
  { num: "04", title: "DEPLOIEMENT", desc: "Publication sur les stores, monitoring et accompagnement post-lancement pour garantir le succes." },
];

const techStack = ["React Native", "Flutter", "Swift", "Kotlin", "Firebase", "Supabase", "Expo", "TestFlight"];

export function CybermonoApplicationMobile() {
  return (
    <main className={poppins.className} style={{ fontFamily: `${poppins.style.fontFamily}, sans-serif` }}>
        ...
        <div className="relative z-10 w-full max-w-[1400px] mx-auto px-6 md:px-12 lg:pl-[10%] py-14 md:py-24 lg:py-0">
          <ScrollReveal direction="up">
            <div className="flex items-center gap-3 mb-8">
              ...
              <span className="text-[10px] uppercase tracking-[0.4em] text-white/60" style={{ fontFamily: "monospace" }}>SERVICE.MOBILE — APPS</span>
            ...
            >
              <span className="block text-[0.5em] text-white/60 mb-2">NOUS DEVELOPPONS</span>
              VOTRE APPLICATION
            </h1>
            <p className="text-white/60 max-w-lg text-lg leading-relaxed mb-10" style={{ fontFamily: "system-ui, sans-serif" }}>
              Applications mobiles natives et cross-platform. Des experiences fluides, performantes et intuitives sur tous les appareils.
            </p>
            <Link
              href="/contact"
        ...
        <div className="max-w-[1400px] mx-auto px-6 md:px-12 relative z-10">
          <ScrollReveal direction="up">
            <div className="text-center mb-20">
              <span className="text-[10px] uppercase tracking-[0.4em] block mb-4" style={{ fontFamily: "monospace", color: GRAY, opacity: 0.7 }}>PLATFORM.SYS — OPTIONS</span>
              ...
              <p className="text-xl" style={{ fontFamily: poppins.style.fontFamily, color: GRAY, fontWeight: 800 }}>
                toutes les technologies mobiles
              </p>
            </div>
          </ScrollReveal>
                  ...
                  <div className="flex gap-6">
                    <div className="shrink-0">
                      <div className="w-14 h-14 flex items-center justify-center border border-black/10 transition-all duration-300 group-hover:bg-black group-hover:border-black">
                        <p.icon className="w-6 h-6 transition-colors duration-300 text-[#111111] group-hover:!text-white" />
                      </div>
                    </div>
                    <div>
                      <h3
      ...
      <section className="relative py-28 md:py-36" style={{ backgroundColor: "white" }}>
        ...
        <div className="max-w-[1400px] mx-auto px-6 md:px-12 relative z-10">
          <ScrollReveal direction="up">
            <div className="text-center mb-20">
              <span className="text-[10px] uppercase tracking-[0.4em] block mb-4" style={{ fontFamily: "monospace", color: GRAY, opacity: 0.7 }}>AGILE.FLOW — SPRINTS</span>
              <h2 className="text-4xl md:text-5xl tracking-tight mb-3" style={{ fontFamily: poppins.style.fontFamily, color: ACCENT, fontWeight: 800 }}>
                NOTRE PROCESSUS
              </h2>
              <div className="w-12 h-1 mx-auto mb-4 bg-black" />
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <ScrollReveal direction="left">
              <div>
                <div className="flex items-center gap-4 mb-8">
                  ...
                  <span className="text-[10px] uppercase tracking-[0.4em] text-white/40" style={{ fontFamily: "monospace" }}>MOBILE.ADV — STRENGTHS</span>
                </div>
                <h2 className="text-4xl md:text-6xl text-white tracking-tight mb-6 leading-[0.9]" style={{ fontFamily: poppins.style.fontFamily, fontWeight: 900 }}>
                  L&apos;AVANTAGE
                  <br />
                  <span style={{ WebkitTextStroke: "2px rgba(255,255,255,0.6)", WebkitTextFillColor: "transparent" }}>MOBILE.</span>
                </h2>
                <p className="text-white/50 text-base leading-relaxed max-w-md" style={{ fontFamily: "system-ui, sans-serif" }}>
                  Le mobile represente 70% du trafic web. Une application native offre une experience utilisateur inegalee et un engagement client superieur.
                </p>
              </div>
            </ScrollReveal>
            ...
            <ScrollReveal direction="right">
              <div className="space-y-6">
                {[
                  { icon: Gauge, label: "Performance", value: "60 fps constant, animations fluides et temps de reponse instantane" },
                  { icon: Shield, label: "Securite", value: "Chiffrement des donnees, authentification biometrique et stockage securise" },
                  { icon: RefreshCw, label: "Mises a jour OTA", value: "Deploiement de mises a jour sans passer par les stores, en temps reel" },
                  { icon: Cpu, label: "Acces natif", value: "Camera, GPS, notifications push, Bluetooth et tous les capteurs du device" },
                ].map((item) => (
      ...
      {/* ═══════════ TECH STACK ═══════════ */}
      <TechStack technologies={techStack} label="STACK.MOBILE — FRAMEWORKS" subtitle="notre expertise mobile" />
        ...
        <div className="max-w-[1400px] mx-auto px-6 md:px-12 relative z-10">
          <ScrollReveal direction="up">
            <div className="grid grid-cols-1 md:grid-cols-4 gap-8 text-center">
              {[
                { value: 80, suffix: "+", label: "APPS DEPLOYEES" },
                { value: 4.8, suffix: "/5", label: "NOTE MOYENNE STORES" },
                { value: 2, suffix: "M+", label: "TELECHARGEMENTS" },
